...
public class RepositoryWithTenantBaseTest
{
    [Fact]
    public void GivenARepositoryWithTenantClass_WhenInstantiated_ThenDbContextIsSet()
    {
    ...
    [Fact]
    public void GivenARepositoryWithTenantClass_WhenDisposed_ThenDbContextIsDisposed()
    {
        var context = new TestContext();
        var target = new TestRepository(context);
    ...
    public class TestRepository : RepositoryWithTenantBase<TestEntity, TestContext, Guid, Guid>
    {
        ...
        public override Task<IEnumerable<TestEntity>> GetAllAsync(Guid tenant)
        {
            throw new NotImplementedException();
        }

        public override IEnumerable<TestEntity> GetAll(Guid tenant)
        {
            throw new NotImplementedException();
        }
    ...
    public class TestEntity : IndexedEntityWithTenantBase<Guid, Guid>
    {
    }
}
